    ...
    <div className="admin-workspace-shell" style={{ display: "flex", flex: 1, minHeight: 0 }}>
      ...
      <aside className="admin-workspace-sidebar" style={{ width: "236px", background: "#ffffff", borderRight: "1px solid #e1e7ec", display: "flex", flexDirection: "column", flexShrink: 0, paddingBottom: "24px" }}>
        ...
        <div className="admin-workspace-sidebar-section" style={{ padding: "8px 10px 0" }}>
          <div className="admin-workspace-sidebar-label" style={{ fontSize: "9px", fontWeight: 700, color: "#64748b", letterSpacing: "1.8px", textTransform: "uppercase", padding: "0 8px", marginBottom: "4px" }}>TEMPLATES</div>

          {/* All */}
          {(() => {
            const active = !typeFilter;
            return (
              <Link href="/admin/agreements?tab=templates" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "8px 10px", borderRadius: "6px", marginBottom: "1px", background: active ? "#f2f5f8" : "transparent", textDecoration: "none", borderLeft: active ? "2px solid #12161c" : "2px solid transparent", color: active ? "#12161c" : "#64748b" }}>
          ...
          {TEMPLATE_TYPES.map(({ type, name, icon }) => {
            ...
            return (
              <Link key={type} href={href} style={{ display: "flex", alignItems: "center", gap: "10px", padding: "8px 10px", borderRadius: "6px", marginBottom: "1px", background: active ? "#f2f5f8" : "transparent", textDecoration: "none", borderLeft: active ? "2px solid #12161c" : "2px solid transparent", color: active ? "#12161c" : "#64748b" }}>
      ...
      <main className="admin-workspace-main" style={{ flex: 1, background: "#eef2f6", display: "flex", flexDirection: "column" }}>
        ...
        <div className="admin-workspace-header" style={{ padding: "28px 32px 0", borderBottom: "1px solid #e1e7ec", background: "#ffffff" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "20px" }}>
            ...
            <span style={{ fontSize: "12px", color: "#64748b" }}>{filtered.length} template{filtered.length !== 1 ? "s" : ""}</span>
          </div>
          ...
          <form method="GET" action="/admin/agreements" style={{ display: "flex", gap: "8px", paddingBottom: "20px" }}>
            ...
            <div style={{ display: "flex", flex: 1, alignItems: "center", background: "#eef2f6", border: "1px solid #c7d0d8", borderRadius: "8px", padding: "0 14px", gap: "8px" }}>
              ...
              <input name="q" defaultValue={q ?? ""} placeholder="Search templates…" style={{ flex: 1, border: "none", background: "transparent", fontSize: "13px", color: "#12161c", outline: "none", padding: "10px 0", fontFamily: "inherit" }} />
            </div>
            ...
            {hasFilter && (
              <Link href="/admin/agreements?tab=templates" style={{ padding: "0 14px", background: "#ffffff", color: "#64748b", border: "1px solid #c7d0d8", borderRadius: "8px", fontSize: "12.5px", display: "flex", alignItems: "center", textDecoration: "none" }}>
                ✕ Clear
              </Link>
            )}
          </form>
        ...
        <div className="admin-workspace-content" style={{ flex: 1, padding: "24px 32px" }}>
          <div className="admin-workspace-table" style={{ background: "#ffffff", border: "1px solid #e1e7ec", borderRadius: "12px", overflow: "hidden" }}>
            ...
            {/* Column headers */}
            <div className="admin-workspace-table-row" style={{ display: "grid", gridTemplateColumns: "1.4fr 1.8fr 110px 1fr", padding: "10px 24px", background: "#eef2f6", borderBottom: "1px solid #e1e7ec" }}>
